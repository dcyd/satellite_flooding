...
from .abstract_model import EncoderDecoder, SiameseEncoderDecoder, PseudoSiameseEncoderDecoder
...
class PseudoSiameseResnet(PseudoSiameseEncoderDecoder):
    def __init__(self, num_classes, num_channels_1, num_channels_2, encoder_name):
        #self.num_channels = num_channels
        super().__init__(num_classes, num_channels_1, num_channels_2, encoder_name)
        #print ("unet.py, class Resnet, self.num_channels", num_channels)
        #print ("unet.py, class Resnet, EncoderDecoder.num_channels", EncoderDecoder.num_channels)
...
class Resnet18_siamese_upsample(SiameseResnet):
    def __init__(self, num_classes, num_channels=3):
        super().__init__(num_classes, num_channels, encoder_name='resnet18')

class Resnet18_pseudosiamese_upsample(PseudoSiameseResnet):
    def __init__(self, num_classes, num_channels_1=3, num_channels_2=4):
        super().__init__(num_classes, num_channels_1, num_channels_2, encoder_name='resnet18')
